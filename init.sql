...
CREATE TABLE
  `locations` (
    ...
    `archived_location_id` int (15) DEFAULT NULL,
...
VALUES
  ...
  (
    168,
    'THS Chromebook Repair/Replacement',
    130,
    128,
    166,
    0
  ...
  (
    169,
    'PHS Chromebook Repair/Replacement',
    131,
    128,
    166,
    0
  ...
  (
    170,
    'Classroom Management (Blocksi/Lanschool)',
    132,
    171,
    209,
    0
  ...
  (
    191,
    'AV Audio Visual Software/System',
    153,
    NULL,
    NULL,
    1
...
--
-- Table structure for table `ticket_email_ids`
--
CREATE TABLE
  `ticket_email_ids` (
    `id` int (11) NOT NULL,
...
CREATE TABLE
  `users` (
    ...
    `gsso` varchar(255) DEFAULT NULL,
    `prefers_left_header` tinyint (4) DEFAULT NULL,
    `ldap_location` int (11) DEFAULT NULL
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
--
ALTER TABLE `exclude_days` ADD PRIMARY KEY (`id`);

--
-- Indexes for table `flagged_tickets`
--
ALTER TABLE `flagged_tickets` ADD PRIMARY KEY (`user_id`, `ticket_id`);
...
--
ALTER TABLE `request_type` ADD PRIMARY KEY (`request_id`);
...
--
-- Indexes for table `ticket_email_ids`
--
ALTER TABLE `ticket_email_ids` ADD PRIMARY KEY (`id`),
ADD KEY `ticket_id` (`ticket_id`);

--
-- Indexes for table `ticket_logs`
--
ALTER TABLE `ticket_logs` ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `exclude_days` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 1;

--
-- AUTO_INCREMENT for table `locations`
--
ALTER TABLE `locations` MODIFY `location_id` int (15) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 1;

--
-- AUTO_INCREMENT for table `notes`
--
ALTER TABLE `notes` MODIFY `note_id` int (20) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 1;

--
-- AUTO_INCREMENT for table `request_type`
--
ALTER TABLE `request_type` MODIFY `request_id` int (25) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 1;
...
--
-- AUTO_INCREMENT for table `ticket_email_ids`
--
ALTER TABLE `ticket_email_ids` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 1;

--
-- AUTO_INCREMENT for table `ticket_logs`
--
ALTER TABLE `ticket_logs` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 1;
...
--
ALTER TABLE `alerts` ADD CONSTRAINT `alerts_ibfk_1` FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (`id`),
ADD CONSTRAINT `alerts_ibfk_2` FOREIGN KEY (`employee`) REFERENCES `users` (`username`);

--
-- Constraints for table `flagged_tickets`
--
ALTER TABLE `flagged_tickets` ADD CONSTRAINT `FK_FlaggedTicketsID` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `notes`
--
ALTER TABLE `notes` ADD CONSTRAINT `fk_ticket_note_id` FOREIGN KEY (`linked_id`) REFERENCES `tickets` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `ticket_email_ids`
--
ALTER TABLE `ticket_email_ids` ADD CONSTRAINT `ticket_email_ids_ibfk_1` FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (`id`);

--
-- Constraints for table `ticket_logs`
--
ALTER TABLE `ticket_logs` ADD CONSTRAINT `fk_ticket_logs` FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (`id`) ON DELETE CASCADE;
