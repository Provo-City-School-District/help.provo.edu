/* PrismJS 1.30.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+c+csharp+cpp+git+http+hsts+javadoclike+markdown+markup-templating+nginx+php+phpdoc+php-extras+powershell+rust+sql+twig+wiki */
var _self =
