...
$res = HelpDB::get()->execute_query("UPDATE users SET active_ticket = NULL, active_ticket_updated = NULL WHERE active_ticket_updated < DATE_SUB(NOW(), INTERVAL 30 MINUTE)");
if (!$res) {
